  ...
  return (
    ...
    <XIcon className='md:hidden absolute top-6 right-6 w-6 h-6 cursor-pointer' onClick={()=>setIsOpen(!isOpen)}/>
      ...
      <div className='flex items-center gap-8'>
       ...
       {
        !user ? (
        <button onClick={openSignIn} className='px-4 py-1 sm:px-4 sm:py-2 bg-primary hover:bg-primary-dull transition rounded-full font-medium cursor-pointer'>Login</button>
        ):(
          <UserButton>
